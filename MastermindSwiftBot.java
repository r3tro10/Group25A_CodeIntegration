...
public class MastermindSwiftBot {
	
	// create an instance of the  API to control the hardware
	static SwiftBotAPI swiftBot = swiftbot.SwiftBotAPI.INSTANCE;
    ...
    public static void main(String[] args) {
        MastermindSwiftBot game = new MastermindSwiftBot();
        game.start();
    }
