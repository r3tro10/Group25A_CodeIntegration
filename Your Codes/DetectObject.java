...
public class DetectObject {
    ...
    public void startTask(SwiftBotAPI sharedBot, Scanner sharedScanner) throws Exception {
        ...
        sharedBot.setUnderlights(0,0,0); // turn off lights
        return;
    }
    ...
    File file = new File("detectobject_log.txt");
